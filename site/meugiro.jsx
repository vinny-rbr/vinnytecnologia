...
function MgHow() {
  const steps = [
    ...
    ["02", "Gerencia pelo celular", "A loja inteira na palma da mão: muda preço, ajusta estoque, controla custo e acompanha o caixa, de onde estiver."],
    ["03", "Conecta com segurança", "O agente trabalha de forma segura, mantendo seus dados sempre protegidos."],
  ];
  return (
    ...
    <section className="mg-sec" id="recursos">
      <div className="wrap">
        <div className="mg-head">
          ...
          <p className="mg-head-p">Feito para supermercado, material de construção e varejo em geral!<br />Os números que importam, rápido e fácil de entender.</p>
        </div>
